...
public class ResulatActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new ResultTempsFragment(), getString(R.string.classement_temps));
        adapter.addFragment(new ResultEcologieFragment(), getString(R.string.classement_ecologie));
        adapter.addFragment(new ResultPratiqueFragment(), getString(R.string.classement_pratique));
